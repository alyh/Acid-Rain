	...
	public static Drawable createButtonBackgrounds(Resources resources) {
		...
		if(Background.getBackgrounds().get(selected).getName().equals("night")){
	        ...
	        states.addState(new int[] {android.R.attr.state_pressed},
	        		resources.getDrawable(R.drawable.night_button_click));
	        states.addState(new int[] {android.R.attr.state_focused},
	        		resources.getDrawable(R.drawable.night_button_color));
	        states.addState(new int[] { },
	        		resources.getDrawable(R.drawable.night_button_color));
		}else if(Background.getBackgrounds().get(selected).getName().equals("sunset")){
			states = new StateListDrawable();
	        states.addState(new int[] {android.R.attr.state_pressed},
	        		resources.getDrawable(R.drawable.sunset_button_click));
	        states.addState(new int[] {android.R.attr.state_focused},
	        		resources.getDrawable(R.drawable.sunset_button_color));
	        states.addState(new int[] { },
	        		resources.getDrawable(R.drawable.sunset_button_color));
		}else if(Background.getBackgrounds().get(selected).getName().equals("sunrise")){
			states = new StateListDrawable();
	        states.addState(new int[] {android.R.attr.state_pressed},
	        		resources.getDrawable(R.drawable.sunrise_button_click));
	        states.addState(new int[] {android.R.attr.state_focused},
	        		resources.getDrawable(R.drawable.sunrise_button_color));
	        states.addState(new int[] { },
	        		resources.getDrawable(R.drawable.sunrise_button_color));
		}else{
			states = new StateListDrawable();
	        states.addState(new int[] {android.R.attr.state_pressed},
	        		resources.getDrawable(R.drawable.main_button_click));
	        states.addState(new int[] {android.R.attr.state_focused},
	        		resources.getDrawable(R.drawable.main_button_color));
	        states.addState(new int[] { },
	        		resources.getDrawable(R.drawable.main_button_color));
		}
		return states;
